...
termux_install_temporary_glibc() {
	...
	# work of multi-compilation and compilation in forked projects
	grep -I -s -r -l "/$PREFIX_TMP_GLIBC/lib/" "$TERMUX_PREFIX_LIB" | xargs sed -i "s|/$PREFIX_TMP_GLIBC/lib/|$TERMUX_PREFIX_LIB/|g"
