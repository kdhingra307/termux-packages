...
termux_setup_golang() {
	...
	if [ "$TERMUX_ON_DEVICE_BUILD" = "false" ]; then
		local TERMUX_GO_VERSION=go1.24.2
		local TERMUX_GO_SHA256=68097bd680839cbc9d464a0edce4f7c333975e27a90246890e9f1078c7e702ad
		...
		export GOROOT="$TERMUX_PREFIX_LIB/go"
	fi
}
